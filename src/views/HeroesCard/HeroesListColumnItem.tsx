...
import './heroesColumnItem.modules.scss'
import { useSelector } from 'react-redux'

const HeroesListColumnItem = ({ hero, size = 'large', idHero, tokenPrice }) => {
        ...
        <div className="flex flex-row flex-wrap justify-between w-full">
          ...
          <div className="w-3/6 xl:w-1/4 grid" style={{ width: '15%', gridTemplateRows: '175px' }}>
            <div
              ...
              style={{ padding: '0px', background: 'transparent', transform: 'scale(50%)' }}
            >
          ...
          {/* Infor */}
          <div className="w-3/6 xl:w-1/4 flex justify-start">
            <div className="flex flex-col flex-wrap justify-center items-start h-full lg:ml-4 gap-4">
              <div className="flex flex-row">
                ...
                <div className="flex flex-col gap-0 ml-2">
                  <div>
                    <span className="heroName-column">{getHeroName()}</span>
                    {hero?.tag === 0 && (
                      <span className="heroOrigin-column">Origin</span>
                    )}
                  </div>
                  <div className="heroID-column">#{getId()}</div>
                </div>
              </div>
              ...
              <PriceBUSD>
                <img
                  ...
                  alt={bnbIcon}
                />
                <span style={{ color: '#FFC247', margin: '0 5px' }}>
          ...
          <div className="w-3/6 md:pl-10 xl:w-1/4 flex justify-start">
            <div className="itemHolder-column flex flex-col flex-wrap justify-center items-start gap-4">
              <Tooltip
                placement="bottom"
                bg="#111111"
                padding={3}
...
export default HeroesListColumnItem
