      ...
      <WrapPool>
        <div className='row'>
          <BoxItem className='mb-32'>
            <p className='main-title mb-8'>HTD Total Mining Pool</p>
          ...
          <BoxItem>
            <div className='flex-box'>
              <div>
                <p className='main-title mb-8'>HTD Earned</p>
        ...
        <div className='row'>
          {items.map((item, index) => (
            <ItemCard>
              ...
              <p className='card-status'>No NFT</p>
              <p className='card-name'>Heroes Item</p>
              <Button variant="primary" className="w-full stake-button">
                Stake
              </Button>
