...
const EggMovement = ({ id, heroesDetails, heroConfig }) => {
  ...
  return (
    <Card>
      <div className="flex flex-row">
        ...
        <div>
          <Flex gridGap={2} mb={2} alignItems="center">
            <h1 className="text-xl font-bold"> SUMMON CARD </h1>
          </Flex>
          <Flex>
      ...
      <div className="flex justify-center mt-2" style={{ backgroundColor: 'rgb(0, 0, 0)', border: '1px solid rgb(67, 67, 68)', borderRadius: "10px"}}>
        <EggCard heroDetails={heroesDetails} />
      </div>
    </Card>
  )
}
