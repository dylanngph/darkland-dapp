...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in HTD prizes this round', {cakePrizeInUsd: cakePriceBusdAsString})
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with HTD, win HTD if your numbers match')}
        </Text>
      </Flex>
