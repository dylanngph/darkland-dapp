...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and DAK pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and DAK pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from DAK pool', data)
  }
