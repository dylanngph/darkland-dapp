...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and ADT pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and ADT pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from ADT pool', data)
  }
