...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and BIG pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and BIG pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from BIG pool', data)
  }
