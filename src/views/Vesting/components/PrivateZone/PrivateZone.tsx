...
const PrivateZone = () => {
  ...
  const strategicVestingContract = useVestingStrategic()
  ...
  const handleClaim = async () => {
    try {
      setPendingTx(true)
      const tx = await callWithGasPrice(strategicVestingContract, 'claim', [])
            ...
            <div>
              ...
              >
                <Flex justifyContent="space-between" sx={{ marginBottom: '15px' }}>
                  <div>Price:</div>
                  <div style={{ fontSize: '16px', fontWeight: '700' }}>1 $BIG = 0.04$</div>
                </Flex>
                <Flex justifyContent="space-between">
                  <div>Token allocation:</div>
                  <div style={{ fontSize: '16px', fontWeight: '700' }}>45,000,000 BIG</div>
                </Flex>
              </div>
              <div>
