...
import { useVesting, useVestingStrategic } from 'hooks/useContract'
import useToast from 'hooks/useToast'
import { useCallWithGasPrice } from 'hooks/useCallWithGasPrice'
import { useWeb3React } from '@web3-react/core'
import {
  useFetchVestingTGE as useFetchPrivate,
  useFetchVestingStage,
} from 'views/Vesting/hooks/useFetchVesting'
...
const StrategicZone = () => {
  ...
  const { canUnlockAmount, infoWallet, balanceOf } = useFetchVestingTGE()
  ...
  return (
    <Page>
      <div className="flex mb-8 items-center">
        ...
        <span className="font-bold text-xl mx-2" style={{ fontSize: '22px' }}>
          /
        </span>
        <span className="font-bold text-xl">Seed Partners</span>
      </div>
      {/* <Hero>
        ...
        <Col>
          ...
          <StyledBox>
            ...
            <Flex>
              ...
              <Money>{balanceOf !== undefined ? formatNumber(balanceOf) : 0} BIG</Money>
            </Flex>
            <div style={{ color: '#E6AB58', fontWeight: '700' }}>Token claimed</div>
            <Flex>
              <img src="/images/coins/big.png" alt="" width="27px" />
              <Money>{infoWallet ? formatNumber(infoWallet[1]) : 0} BIG</Money>
            </Flex>
            <div style={{ color: '#E6AB58', fontWeight: '700' }}>Next claimable on</div>
            <Flex>
              <img src="/images/coins/big.png" alt="" width="27px" />
              <Money>{infoWallet ? formatNumber(infoWallet[0] - infoWallet[1]) : 0} BIG</Money>
            </Flex>
          </StyledBox>
          <StyledBox>
            ...
            <Flex>
              <img src="/images/coins/big.png" alt="" width="27px" />
              <Money>{infoWallet ? formatNumber(infoWallet[2]) : 0} BIG</Money>
            </Flex>
            <Button disabled={canUnlockAmount === 0} onClick={() => handleClaim()}>
              Claim
            </Button>
            <Text>
              *Note: Tokens are vested at the time of TG will be automatically sent to the investors
              wallets at the time of TGE.
            </Text>
            {/* </Button>
                        <ConnectWalletButton /> */}
          </StyledBox>
            ...
            <div>
              ...
              >
                <Flex justifyContent="space-between" sx={{ marginBottom: '15px' }}>
                  <div>Price:</div>
                  <div style={{ fontSize: '16px', fontWeight: '700' }}>1 $BIG = 0.03$</div>
                </Flex>
                <Flex justifyContent="space-between">
                  <div>Token allocation:</div>
                  <div style={{ fontSize: '16px', fontWeight: '700' }}>8,000,000 BIG</div>
                </Flex>
              </div>
              <div>
                Thank you for placing your trust and investment in{' '}
                <strong style={{ color: '#FFA800' }}>Dark Land Survival</strong>. We&apos;re honored
                to have you on board and it&apos;s our responsibility to expand the project&apos;s
                vision and bring a good return on investment to you!
                <br />
                To ensure the success of our project and your return on investment, please follow
                these instructions:
                <br />
                <br />
