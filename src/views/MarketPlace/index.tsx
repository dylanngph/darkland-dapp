...
const MarketPlace = () => {
  ...
  // const tabSelected = useSelector<AppState, AppState['user']['userSelected']>(
  //   (state: AppState) => state.user.userSelected,
  // )
  // const [tab, setTab] = useState(tabSelected)
  // console.log('🚀 ~ file: index.tsx ~ line 21 ~ MarketPlace ~ tabSelected', tabSelected)
  // console.log('🚀 ~ file: index.tsx ~ line 24 ~ MarketPlace ~ tab', tab)
