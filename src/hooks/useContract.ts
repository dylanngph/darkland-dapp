...
import {
  ...
  openMysteryBoxContract,
  getMysteryBoxWhitelistContract,
  getBoxContract,
  getOpenBoxContract,
...
export const useFarmNft = (id) => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getFarmNftContract(id, library.getSigner()), [id, library])
}

export const useGetNftContract = (id) => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getNftContract(id, library.getSigner()), [id, library])
}
...
export const useBounty = (slug) => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getBountyContract(slug, library.getSigner()), [slug, library])
}
...
export const useIdo = (id) => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getIdoContract(id, library.getSigner()), [id, library])
}
...
export const useVestingStrategic = () => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getVestingStrategicContract(library.getSigner()), [library])
}

export const useClaimMysteryBox = () => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getMysteryBoxContract(library.getSigner()), [library])
}

export const useApproveMysteryBox = () => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getMysteryBoxContract(library.getSigner()), [library])
}
...
export const useOpenMysteryBox = () => {
  const {library} = useActiveWeb3React()
  return useMemo(() => openMysteryBoxContract(library.getSigner()), [library])
}

export const useOpenMysteryBoxTicket = (type) => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getMysteryBoxWhitelistContract(type, library.getSigner()), [library, type])
}
...
export const useKsharkContract = () => {
  const {library} = useActiveWeb3React()
  return useMemo(() => getKsharkContract(library.getSigner()), [library])
}

export const useMarketplaceBox = (type) => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getMarketplaceContract(type, library.getSigner()), [library, type])
}

export const useBox = (id: number) => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getBoxContract(id, library.getSigner()), [library, id])
}

export const useOpenBox = (id: number) => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getOpenBoxContract(id, library.getSigner()), [library, id])
}

export const useHeroContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getHeroContract(library.getSigner()), [library])
}
