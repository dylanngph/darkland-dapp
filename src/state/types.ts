...
export interface PoolNft extends PoolNftConfig {
  totalStaked?: BigNumber
  stakingLimit?: BigNumber
  stakingTokenPrice?: number
  userData?: {
...
export interface FarmNft extends FarmNftConfig {
  totalStaked?: BigNumber
  stakingLimit?: BigNumber
  stakingTokenPrice?: number
  userData?: {
...
export interface PoolsNftState {
  data: PoolNft[]
  cakeVault: CakeVault
  userDataLoaded: boolean
}

export interface FarmsNftState {
  data: FarmNft[]
  cakeVault: CakeVault
  userDataLoaded: boolean
}
...
export interface State {
  ...
  block: BlockState
  farms: FarmsState
  farmsNft: FarmsNftState
  pools: PoolsState
  poolsNft: PoolsNftState
